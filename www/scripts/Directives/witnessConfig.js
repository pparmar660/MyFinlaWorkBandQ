...
BandQModule.directive("witnessConfig", ["$http", "$compile","$timeout","$rootScope", function ($http, $compile,$timeout,$rootScope) {
        ...
        var linker = function (scope, element, attr) {
            ...
            if (scope.template in fieldsArray) {
                ...
                if ($rootScope.uiLoadedwitnessConfig)
                    return;
                $rootScope.uiLoadedwitnessConfig = true;
