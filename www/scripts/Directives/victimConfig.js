...
BandQModule.directive("victimConfig", ["$http", "$compile", "$timeout", "$rootScope", function ($http, $compile, $timeout, $rootScope) {
        ...
        var linker = function (scope, element, attr) {
            ...
            $timeout(function () {
                ...
                if ($rootScope.uiLoadedvictimConfig)
                    return;
                $rootScope.uiLoadedvictimConfig = true;
