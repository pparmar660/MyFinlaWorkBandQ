BandQModule.controller('victimDetailCnt', function ($scope, VictimWitness, $rootScope, imageService,
                ...
                TaskAndCheckList.getTaskList("Victims & Witness", $scope.victim_Id, function (status, data) {
                     if(status){
                        $scope.showChecklist=true;
                          $("#victimTasksTab").removeClass("hideTab");
                    }else{
                      $scope.showChecklist=false;   
                        $("#victimTasksTab").addClass("hideTab");
                    }
                    $scope.taskAndCheckList1 = data;
                    //console.log("");
                });
                VictimWitness.getVictimeDetaile($scope.victim_Id, function (status, data, victimDetails) {
                    ...
                    $scope.$apply(function () {
                        ...
                        if ($scope.incidents.length <= 0) {
                            $("#victimIncidentTab").addClass("hideTab");
                            $scope.showVictimLinkedDetailsTab = false;
                        }
                        else {
                            $("#victimIncidentTab").removeClass("hideTab");
                            $scope.showVictimLinkedDetailsTab = true;
                        }
                        ...
                        if ($scope.victimData.add_comm == 1) {
                            $scope.isCommAllowed = true;
                             $("#victimCommsTab").removeClass("hideTab");
                        } else {
                            $scope.isCommAllowed = false;
                             $("#victimCommsTab").addClass("hideTab");
                        }
...
//                scope.catagory = $scope.catagory;
                globalService.setVictim({'victimDetails': scopelist.selectedVictims, 'isvictimInvolved': 'yes'});
            }
