BandQModule.service("userConfig", function () {
    ...
    var isRequestSent = false;
        ...
        this.getUserConfigAtLogin = function () {
        if (isRequestSent)
            return;
        isRequestSent = true;
       webRequestObject.postRequestSync(self, "GET", constanObject.userInfo, "", constanObject.WebRequestType.UserInfo, true,"Downloading Configurations...");
    };
    ...
    this.getUserConfig = function () {
        if (isRequestSent)
            return;
        isRequestSent = true;
       webRequestObject.postRequestSync(self, "GET", constanObject.userInfo, "", constanObject.WebRequestType.UserInfo, true);
    };
