...
BandQModule.directive("offenderConfig", ["$http", "$compile", "$timeout", "$window", "$q","$rootScope", function ($http, $compile, $timeout, $window, $q,$rootScope) {
        ...
        var linker = function (scope, element, attr) {
            ...
            $timeout(function () {
                ...
                if ($rootScope.uiLoadedOffender)
                    return;
                $rootScope.uiLoadedOffender = true;
