BandQModule.service('getVictimWitnessCategory', function () {
    ...
    this.download = function () {
        ...
        if (webRequestObject && constanObject) {
            webRequestObject.postRequestSync(this, "GET", constanObject.VICTIME_CATEGORY, null, 101, true);
            isRequestSend = true;
        ...
        if (status == constanObject.ERROR) {
            ...
            switch (requestType) {
                case 101:
                    ...
                    dataBaseObj.insertData(VICTIME_WITNESS_CATAGORY, JSON_FIELD_ARRAY, response, true);
                    isRequestSend = false;
