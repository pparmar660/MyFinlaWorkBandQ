        ...
        IncidentReport.getIncidentReportDetail(incidentId, function (status, data) {
            ...
            $scope.$apply(function () {
                ...
                if ($scope.incident.add_comm == 0 && $scope.incident.has_task == 1)
                    $("#item1").click();
//               $('#tabsOfTaskAndComms').tabs('select', 1);
                //  $('.active_tabs.resp-tab-content').css('display', 'block');
...
//        $('.removeAllClass li').removeClass("resp-tab-active");
//        $('.removeAllClass li').eq(0).addClass("resp-tab-active");
////        $('.incident-victim-tabs .hor_1 > div').css("display","none");
//        $(' .hor_1 > div').removeClass("resp-tab-content-active");
//        $(' #in_tab1').addClass("resp-tab-content-active").css("display","block");
