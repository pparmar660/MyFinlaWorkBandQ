...
var staticOnlineOffline=false;

var showNotification = false;
var globalHideDowloadLoder=false; 
...
goToResource = function () {
    window.location.href = "resource_index.html";
...
function getUserConfig() {
    if (dataBaseObj) {
        dataBaseObj.getDatafromDataBase("SELECT * from " + TABLE_USER_INFO, function (result) {
            ...
            User_Access_Leve=data.user_config.id_ulv;
